  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        glow: "0 0 24px oklch(0.72 0.18 220 / 0.25)",
        "glow-lg": "0 0 48px oklch(0.72 0.18 220 / 0.2)",
        "card-hover": "0 8px 32px oklch(0 0 0 / 0.4), 0 0 0 1px oklch(0.72 0.18 220 / 0.2)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
