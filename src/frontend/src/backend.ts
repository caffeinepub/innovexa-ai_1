...
export class Backend implements backendInterface {
    ...
    async sendMessage(arg0: Array<[string, string]>, arg1: string, arg2: Mode): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(arg0, arg1, to_candid_Mode_n1(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Mode): {
    pro: null;
} | {
    fast: null;
} | {
